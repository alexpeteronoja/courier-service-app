...
import { BellIcon, Dot, Menu, Package, SearchIcon, LogOut } from "lucide-react";
        ...
        <div className="h-18 mx-5 sm:mx-8 flex items-center justify-between text-white">
          ...
          <div className="flex gap-x-4 items-center">
            ...
            <div className="relative" ref={dropdownRef}>
              ...
              {/* Dropdown */}
              {openMenu && (
                <div className="absolute right-0 top-15 cursor-pointer w-48 rounded-xl bg-white shadow-lg border border-gray-200 overflow-hidden z-50">
                  <button
                    onClick={() => logoutMutate()}
                    className="w-full flex items-center gap-3 px-4 py-3 text-sm text-red-500 hover:bg-gray-100 transition"
                  >
